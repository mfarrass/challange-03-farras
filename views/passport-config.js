...
//     // Jika user tidak ditemukan 
    if ( user == null ) {
      return done(null, false, {message: 'Masukkan username dan password yang benar. Perhatikan penggunaan huruf kapital.'}) // autentikasi FALSE & mengirim pesan error
    }
  ...
  passport.use(
    new LocalStrategy(
      { usernameField: 'username', password: 'password'}, authenticateUser ))
